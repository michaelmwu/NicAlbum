...
; vession to be written in the filename
!define ALT_VER "1_3"

; plugin name
!define PLUG "Nic's Album Shuffle"

; plugin name to be written in the filename
!define PLUG_ALT "Album_Shuffle"

; plugin file
!define PLUG_FILE "gen_nic"
